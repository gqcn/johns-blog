...
角色：你是一名项目管理专家、团队管理专家
背景：
1. 我正在编写一篇文章，介绍 《QBQ 问题背后的问题》，文章的文件路径: /Users/john/Workspace/github/gqcn/johns-blog/docs/hidden/3000-其他文档/2-QBQ 问题背后的问题.md


要求：我需要你按照以下要求完成文章的编写：
1. 在介绍QBQ之前，先介绍下QBQ需要解决的问题是什么，或者是为了解决什么想象
2. 介QBQ的核心思想，如何将该思想运用到我们得生活和职场中
3. 通过例子的形式更进一步介绍QBQ思想的好处