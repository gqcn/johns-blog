...
背景：
1. 该文章是介绍NFD和GFD技术的，文章路径：/Users/john/Workspace/github/gqcn/johns-blog/docs/docs/1000-AI技术/200-AI基础架构/100-NVIDIA/2000-NFD&GFD.md
2. 我发现该文章针对NFD标签的介绍并不全面，例如，经过我抽查发现缺失了feature.node.kubernetes.io/rdma.available和feature.node.kubernetes.io/rdma.capable这2个标签的介绍内容，因此我需要你帮我完善该文章中NFD标签的介绍内容。
要求：
1. 梳理nfd的源码，源码项目路径：/Users/john/Workspace/github/kubernetes-sigs/node-feature-discovery 根据源码审查当前文档中针对NFD标签的介绍内容的正确性，修正错误的介绍，并且补充遗漏的标签介绍内容。