...
理解该文章的内容： /Users/john/Workspace/github/gqcn/johns-blog/docs/docs/1000-AI技术/200-AI基础架构/300-RDMA/3000-RDMA硬件管理及网络拓扑信息查看.md
并完成以下任务：
1. 参考同级目录下的其他文章，补充完善该文章顶部的frontmatter内容。
2. 完善【相关管理工具】章节下各个命令的介绍，通过表格形式展示。
3. 在InfiniBand中的【PCI NFD标签】栏目下需要补充介绍各个标签的含义，通过表格形式展示。
4. 在InfiniBand和RoCE的【RDMA设备信息】栏目下的设备信息输出中，需要增加对关键信息的注释说明。
5. 在【InfiniBand拓扑信息】栏目下的信息输出中，需要增加对关键信息的注释说明。
6. 在【Ethernet拓扑信息】栏目下的信息输出中，需要增加对关键信息的注释说明。