...
## helm介绍及常用指令
我正在编写一篇关于helm介绍及常用指令的文章，文章的文件路径：/Users/john/Workspace/github/gqcn/johns-blog/docs/docs/3000-云原生/500-helm介绍及常用指令.md
该文章需要：
1. 介绍helm的背景和用途
2. 介绍helm的安装和配置
3. 介绍helm的常用指令以及对应的指令使用示例
...
# Volcano Queue&Job&Pod资源抢占设计

角色：你是一名AI算力系统研发专家，也是一名Kubernetes云原生研发专家。
背景：
1. 我正在编写一篇文章，介绍Volcano Queue&Job&Pod资源抢占设计，文章的文件路径: /Users/john/Workspace/github/gqcn/johns-blog/docs/docs/3000-云原生/2-Volcano/3750-Volcano Queue&Job&Pod资源抢占设计.md


要求：我需要你按照以下要求完成文章的编写：
1. 介绍资源抢占的背景和用途。
2. 介绍Volcano Queue&Job&Pod这3类资源个字的资源抢占设计的实现原理，以及实现方式。
3. 当出现资源抢占时，介绍3种资源之间的抢占关系。
...
角色：你是一名AI大模型技术专家。
背景：
1. 我正在编写一篇文章，介绍 AI通用大模型和推理大模型的区别，文章的文件路径: /Users/john/Workspace/github/gqcn/johns-blog/docs/docs/4000-AI技术/1500-通用大模型和推理大模型的区别.md


要求：我需要你按照以下要求完成文章的编写：
1. 需要先介绍大模型出现的背景，解决什么痛点。
2. 分别介绍通用大模型和推理大模型的定义。
3. 介绍通用大模型和推理大模型的区别，并且需要通过具体的示例介绍两者区别。
4. 普通人，特别是软件开发者，在使用AI大模型的时候，如何选择该使用通用大模型还是推理大模型，并且通过示例来介绍如何选择。


# AI算力管理挑战：资源碎片化的思考

角色：你是一名AI算力系统架构师、研发专家，并且是一位云原生专家。
背景：
1. 我正在编写一篇文章，介绍在AI算力系统建设中，对资源碎片化问题的思考，文章的文件路径: /Users/john/Workspace/github/gqcn/johns-blog/docs/docs/4000-AI技术/9000-AI算力管理挑战：资源碎片化的思考.md


要求：我需要你按照以下要求完成文章的编写：
1. 介绍AI算力管理的背景以及目标
2. 介绍资源碎片化的含义，并举例说明具体痛点，这里的资源碎片化在大模型中主要是加速卡资源的碎片化
3. 结合AI大模型训练推理行业中，对资源碎片化优化的最佳实践，你提出几点常见的资源碎片化优化方案
4. 谈一谈AI大模型行业内对资源碎片化的未来可能得技术演进方向