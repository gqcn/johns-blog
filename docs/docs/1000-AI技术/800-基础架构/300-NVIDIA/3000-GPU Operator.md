...
![GPU Operator自动化部署GPU组件架构示意图](<assets/GPU Operator技术介绍/image.webp>)
...
![GPU Operator状态机流程图](<assets/GPU Operator技术介绍/image-1.webp>)
...
![GPU Operator包含的核心组件架构图](./assets/GPU Operator技术介绍/image-2.webp)
...
详细介绍请参考文章：[Decvice Plugin](../../../2000-云原生/200-Kubernetes/2000-Decvice%20Plugin.md)
...
详细介绍请参考文章：[DCGM Exporter（GPU 监控方案）](../../850-可观测性/4000-DCGM%20Exporter.md)
