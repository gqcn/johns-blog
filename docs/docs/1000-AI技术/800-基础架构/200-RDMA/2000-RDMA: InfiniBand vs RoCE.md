...
![NVIDIA InfiniBand网卡产品系列型号列表](<assets/2000-InfiniBand vs RoCE/image.webp>)

![NVIDIA InfiniBand网卡详细规格参数对比表](<assets/2000-InfiniBand vs RoCE/image-1.webp>)
...
![InfiniBand基于信用的流量控制机制示意图](<assets/2000-InfiniBand vs RoCE/image-2.webp>)
...
![RoCE v2网络分布式架构拓扑图](<assets/2000-InfiniBand vs RoCE/image-3.webp>)
...
![RDMA网卡产品速率和规格对比表](<assets/2000-InfiniBand vs RoCE/image-4.webp>)
...
![数据中心交换机Broadcom Tomahawk芯片系列](<assets/2000-InfiniBand vs RoCE/image-5.webp>)
...
![InfiniBand与RoCE v2技术特性对比表](<assets/2000-InfiniBand vs RoCE/image-6.webp>)
...
![InfiniBand与RoCE v2业务性能延迟对比图](<assets/2000-InfiniBand vs RoCE/image-7.webp>)
