...
![Prefill和Decode阶段对Batch Size响应特性对比图](assets/PD(Prefill&Decode)分离介绍/image.webp)
...
![传统Prefill和Decode一体化部署资源竞争示意图](assets/PD(Prefill&Decode)分离介绍/image-2.webp)
...
![Prefill和Decode分离部署架构示意图](assets/PD(Prefill&Decode)分离介绍/image-1.webp)
