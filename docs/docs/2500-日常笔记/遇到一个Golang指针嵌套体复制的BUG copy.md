...
![](/attachments/image2023-7-25_11-44-50.webp)

其中的`resourceV1.GetTemplateRes`结构体的定义如下：

![](/attachments/image2023-7-25_11-46-26.webp)

将代码改为如下即可解决问题，相当于增加了一个`if`判断：

![](/attachments/image2023-7-25_11-47-33.webp)

## 排查2

经过进一步排查，发现根因在这里：

![](/attachments/image2023-7-25_11-58-44.webp)
