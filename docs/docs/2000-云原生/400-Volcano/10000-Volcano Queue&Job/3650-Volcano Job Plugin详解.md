...
> 关于使用`Volcano Job`中运行`Ray`节点的详细调研测试请参考：[通过Volcano Job插件部署使用Ray Cluster](../../../1000-AI技术/600-训练微调/200-开发训练组件/300-Ray分布式计算引擎/3000-通过Volcano%20Job插件部署使用Ray%20Cluster.md)
